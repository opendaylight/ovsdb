...
public class HwvtepConnectionInstance {
    ...
    private void monitorAllTables(String database, DatabaseSchema dbSchema) {
        ...
        if (tables != null) {
            ...
            for (String tableName : tables) {
                ...
                MonitorRequestBuilder monitorBuilder = MonitorRequestBuilder.builder(tableSchema);
    ...
    public <E extends TableSchema> TableUpdates monitor(DatabaseSchema schema,
                                                        List<MonitorRequest> monitorRequests, MonitorCallBack callback) {
        return client.monitor(schema, monitorRequests, callback);
    }

    public <E extends TableSchema> TableUpdates monitor(DatabaseSchema schema, List<MonitorRequest> monitorRequests,
