...
import org.opendaylight.ovsdb.hwvtepsouthbound.reconciliation.configuration.OperationalNodeListener;
...
public class HwvtepSouthboundProvider implements AutoCloseable {
    ...
    private OperationalNodeListener operationalNodeListener;
    ...
    public void init() {
        ...
        operationalNodeListener = new OperationalNodeListener(db, cm);
