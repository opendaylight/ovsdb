...
public class HwvtepTableReader {
    ...
    public HwvtepTableReader(final HwvtepConnectionInstance connectionInstance) {
        ...
        final McastMacsRemote mcastMacsTable = TyperUtils.getTypedRowWrapper(dbSchema, McastMacsRemote.class, null);
        ...
        final UcastMacsRemote ucastMacsTable = TyperUtils.getTypedRowWrapper(dbSchema, UcastMacsRemote.class, null);
        ...
        final LogicalSwitch lsTable = TyperUtils.getTypedRowWrapper(dbSchema, LogicalSwitch.class, null);
        if (lsTable != null) {
        ...
        final PhysicalLocator plTable = TyperUtils.getTypedRowWrapper(dbSchema, PhysicalLocator.class, null);
        if (plTable != null) {
