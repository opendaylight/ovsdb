...
public class TransactionHistoryCmd extends OsgiCommandSupport {
    ...
    protected Object doExecute() throws Exception {
        Map<InstanceIdentifier<Node>, TransactionHistory> controllerTxLogs = hwvtepConnectionManager.getControllerTxHistory();
        Map<InstanceIdentifier<Node>, TransactionHistory> deviceUpdateLogs = hwvtepConnectionManager.getDeviceUpdateHistory();
        if (nodeid != null) {
