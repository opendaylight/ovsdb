...
public class HAUtil {
    ...
    public static void setNextId() {
        ...
        id.set(new Integer(counter.get()));
    }
    ...
    public static HwvtepLogicalSwitchRef getLogicalSwitchRef(HwvtepLogicalSwitchRef src, InstanceIdentifier<Node> nodePath) {
        ...
        //LOG.error("getLogicalSwitchRef before {} ",srcVal);
        //LOG.error("getLogicalSwitchRef after {} ",dstVal);
    ...
    public static NodeBuilder getHAChildNodeBuilder(DataBroker db, InstanceIdentifier<Node> nodePath,
                NodeId childNodeId) {
        NodeBuilder haChildNodeBuilder = null;
        try {
        ...
        if (haChildNodeBuilder == null) {
            haChildNodeBuilder = new NodeBuilder();
