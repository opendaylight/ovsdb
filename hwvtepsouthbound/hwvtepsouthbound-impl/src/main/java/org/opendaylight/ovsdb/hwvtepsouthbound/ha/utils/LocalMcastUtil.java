...
public class LocalMcastUtil {
    ...
    public static class LocalMcastIdGenerator implements Function<LocalMcastMacs, InstanceIdentifier<LocalMcastMacs>> {
        InstanceIdentifier<Node> dstNodePath;
        public LocalMcastIdGenerator(InstanceIdentifier<Node> dstNodePath) {
            this.dstNodePath = dstNodePath;
        }

        @Nullable
        @Override
        public InstanceIdentifier<LocalMcastMacs> apply(LocalMcastMacs localMcastMacs) {
            return dstNodePath.augmentation(HwvtepGlobalAugmentation.class).child(LocalMcastMacs.class, localMcastMacs.getKey());
        }
    }
}
