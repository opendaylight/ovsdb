...
public class HwvtepOperationalState {
    ...
    public UUID getTxCreatedPhysicalLocatorUUID(InstanceIdentifier<TerminationPoint> iid) {
    ...
    public void setTxCreatedPhysicalLocatorUUID(InstanceIdentifier<TerminationPoint> iid,
                                                UUID uuid) {
