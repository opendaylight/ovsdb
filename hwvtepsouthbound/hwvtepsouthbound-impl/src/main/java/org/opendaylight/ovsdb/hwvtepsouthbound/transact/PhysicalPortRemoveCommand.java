...
public class PhysicalPortRemoveCommand extends AbstractTransactCommand {
    ...
    public void execute(TransactionBuilder transaction) {
        //TODO reuse from base class instead of extractRemoved2
        Map<InstanceIdentifier<Node>, List<HwvtepPhysicalPortAugmentation>> removeds =
                extractRemoved2(getChanges(),HwvtepPhysicalPortAugmentation.class);
        if (!removeds.isEmpty()) {
    ...
    protected Map<InstanceIdentifier<Node>, List<HwvtepPhysicalPortAugmentation>> extractRemoved2(
