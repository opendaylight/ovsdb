...
public class UcastMacsLocalUpdateCommand extends AbstractTransactCommand<LocalUcastMacs, HwvtepGlobalAugmentation> {
    ...
    private void updateUcastMacsLocal(final TransactionBuilder transaction,
        ...
        for (LocalUcastMacs localUcastMac: localUcastMacs) {
            ...
            if (!operationalMacOptional.isPresent()) {
                ...
                UcastMacsLocal extraMac = transaction.getTypedSchema(UcastMacsLocal.class);
    ...
    private void setLocator(final TransactionBuilder transaction, final UcastMacsLocal ucastMacsLocal, final LocalUcastMacs inputMac) {
