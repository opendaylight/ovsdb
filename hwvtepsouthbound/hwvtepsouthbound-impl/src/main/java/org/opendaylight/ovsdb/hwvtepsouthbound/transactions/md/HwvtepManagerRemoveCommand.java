...
public class HwvtepManagerRemoveCommand extends AbstractTransactionCommand {
    ...
    public HwvtepManagerRemoveCommand(final HwvtepConnectionInstance key, final TableUpdates updates,
    ...
    public void execute(final ReadWriteTransaction transaction) {
        Collection<Manager> deletedManagerRows = extractRowsRemoved(Manager.class).values();
