...
public class HwvtepTunnelUpdateCommand extends AbstractTransactionCommand {
    ...
    private InstanceIdentifier<TerminationPoint> getPhysicalLocatorRefFromUUID(InstanceIdentifier<Node> psIid, UUID uuid) {
        ...
        return HwvtepSouthboundMapper.createInstanceIdentifier(psIid, pLoc);
    }
