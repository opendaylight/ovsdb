...
public class HwvtepUcastMacsLocalUpdateCommand extends AbstractTransactionCommand {
    ...
    private Node buildConnectionNode(Collection<UcastMacsLocal> ucml) {
    ...
    private LocalUcastMacs buildLocalUcastMac(UcastMacsLocal ucml) {
        InstanceIdentifier<Node> nodeIid = getOvsdbConnectionInstance().getInstanceIdentifier();
        ...
        LocalUcastMacs mac = ucmlBuilder.build();
        return mac;
    }
