...
public class PhysicalPortUpdateCommand extends AbstractTransactionCommand {
    ...
    private void updatePort(
        ...
        updateUuid(portUpdate, tpAugmentationBuilder);
    }
    ...
    private void updateUuid(PhysicalPort portUpdate, HwvtepPhysicalPortAugmentationBuilder tpAugmentationBuilder) {
