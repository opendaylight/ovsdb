...
public class PhysicalPortUpdateCommand extends AbstractTransactionCommand {
    ...
    private HwvtepLogicalSwitchRef getLogicalSwitchRef(UUID switchUUID) {
        LogicalSwitch logicalSwitch = getOvsdbConnectionInstance().getDeviceState().getLogicalSwitch(switchUUID);
        ...
        LOG.trace("Available LogicalSwitches: {}",
                        getOvsdbConnectionInstance().getDeviceState().getLogicalSwitches().values());
        return null;
    }
