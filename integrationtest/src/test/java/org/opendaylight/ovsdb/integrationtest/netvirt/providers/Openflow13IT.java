...
public class Openflow13IT extends OvsdbIntegrationTestBase {
    ...
    //@Inject
    private OF13Provider of13Service = new OF13Provider();
    ...
    public void areWeReady() throws InterruptedException, ExecutionException, IOException, TimeoutException {
        ...
        //Component configurationService = dm.createComponent();
        ...
        log.info("classifier: {}", networkingProviderManager.getProvider(node).getName());
    }
