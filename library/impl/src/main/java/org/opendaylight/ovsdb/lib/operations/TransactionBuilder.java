...
public class TransactionBuilder {
    ...
    public final @NonNull DatabaseSchema getDatabaseSchema() {
        return databaseSchema;
    }

    public final <T> T getTypedRowWrapper(final Class<T> klazz) {
        return TyperUtils.getTypedRowWrapper(databaseSchema, klazz);
    }

    public final <T> T getTypedRowSchema(final Class<T> klazz) {
