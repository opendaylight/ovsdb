...
public abstract class TableSchema<E extends TableSchema<E>> {
    ...
    public TableSchema(final String name, final Map<String, ColumnSchema> columns) {
        this.name = name;
    ...
    public <K,V> ColumnSchema<E, Map<K,V>> multiValuedColumn(final String column, final Class<K> keyType, final Class<V> valueType) {
        //todo exception handling
