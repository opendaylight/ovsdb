...
public class OvsDBClientTestIT extends OvsdbTestBase {
    ...
    public void testTransact() throws IOException, InterruptedException, ExecutionException {
        ...
        createBridgeTransactionTest();
        abortTransactionTest();
        assertTransactionTest();
    }
    ...
    private void createBridgeTransactionTest() throws IOException, InterruptedException, ExecutionException {
        Assert.assertNotNull(dbSchema);
        TableSchema<GenericTableSchema> bridge = dbSchema.table("Bridge", GenericTableSchema.class);
    ...
    private void assertTransactionTest() throws InterruptedException, ExecutionException {
        Assert.assertNotNull(dbSchema);
        TableSchema<GenericTableSchema> bridge = dbSchema.table("Bridge", GenericTableSchema.class);
        ColumnSchema<GenericTableSchema, String> name = bridge.column("name", String.class);
    ...
    private void abortTransactionTest() throws InterruptedException, ExecutionException {
        Assert.assertNotNull(dbSchema);
        TableSchema<GenericTableSchema> bridge = dbSchema.table("Bridge", GenericTableSchema.class);
        ColumnSchema<GenericTableSchema, String> name = bridge.column("name", String.class);
