...
import org.opendaylight.ovsdb.neutron.impl.provider.ProviderNetworkManager;
    ...
    private void handleInterfaceDelete (Node node, String uuid, Interface intf, boolean isLastInstanceOnNode) {
        ...
        if (network != null) {
            if (isLastInstanceOnNode) {
                TenantNetworkManager.getManager().reclaimTenantNetworkInternalVlan(node, uuid, network);
            }
