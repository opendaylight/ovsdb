...
class OF13ProviderManager extends ProviderNetworkManager {
     ...
     * @param srcport      Integer representing a source TCP port
     * @return             matchBuilder Map MatchBuilder Object with a match
     */
    protected static MatchBuilder createSetSrcTcpMatch(MatchBuilder matchBuilder, PortNumber srcport) {
    ...
    protected static MatchBuilder createSetDstTcpMatch(MatchBuilder matchBuilder, PortNumber tcpport) {
        ...
        PortNumber srcport = new PortNumber(tcpport);
        TcpMatchBuilder tcpmatch = new TcpMatchBuilder();
     ...
     * @return ib Map InstructionBuilder with instructions
     */
    protected static InstructionBuilder createSetDestinationUDPPort(InstructionBuilder ib, PortNumber udpport) {
        ...
        // Build the Destination TCP Port
        PortNumber tcpdstport = new PortNumber(udpport);
        TcpMatchBuilder tcpmatch = new TcpMatchBuilder();
        tcpmatch.setTcpDestinationPort(tcpdstport);
     ...
     * @return ib Map InstructionBuilder with instructions
     */
    protected static InstructionBuilder createSetSrcUDPPort(InstructionBuilder ib, Short udpport) {
        ...
        // Build the Destination TCP Port
        PortNumber tcpdstport = new PortNumber(Integer.valueOf(udpport));
        TcpMatchBuilder tcpmatch = new TcpMatchBuilder();
        tcpmatch.setTcpDestinationPort(tcpdstport);
