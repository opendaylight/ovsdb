        ...
        try {
            ...
            if (intfs != null) {
                for (org.opendaylight.ovsdb.lib.table.internal.Table<?> row : intfs.values()) {
                    ...
                    if (ethIntf.getName().equalsIgnoreCase(AdminConfigManager.getManager().getPhysicalInterfaceName(node, network.getProviderPhysicalNetwork()))) {
    ...
    private void removeVlanRules (NeutronNetwork network, Node node,
        ...
        try {
            ...
            if (intfs != null) {
                for (org.opendaylight.ovsdb.lib.table.internal.Table<?> row : intfs.values()) {
                    Interface ethIntf = (Interface)row;
                    if (ethIntf.getName().equalsIgnoreCase(AdminConfigManager.getManager().getPhysicalInterfaceName(node,
