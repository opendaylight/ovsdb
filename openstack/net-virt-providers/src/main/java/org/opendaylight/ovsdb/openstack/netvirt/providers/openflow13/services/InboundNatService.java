...
public class InboundNatService extends AbstractServiceInstance implements ConfigInterface, InboundNatProvider {
    ...
    public Status programIpRewriteRule(Long dpid, String srcTunnId, InetAddress matchAddress,
        ...
        // TODO: Embed here a flow example that explains how this table is used.
        ...
        // FIXME: turn the block below into a function to make this code easier to read.
        // FIXME: use REGISTER to recall the fact that matched an ipRewrite
        ...
        String flowId = "InboundNAT_" + srcTunnId + "_" + rewriteAddress.getHostAddress();
