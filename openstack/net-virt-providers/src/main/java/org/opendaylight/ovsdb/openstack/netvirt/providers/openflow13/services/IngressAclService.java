...
public class IngressAclService extends AbstractServiceInstance {
    ...
    public static final short EGRESS_ACL = 40; // Flows Sourced from the VM Port go here
    public static final short LBAAS_ACL = 50; // Egress ACL table drains traffic to this table
    public static final short INGRESS_ACL = 90; // Flows Destined to the VM Port go here
    public static final short OUTBOUND_SNAT = 100; // Ingress ACL table drains traffic to this table
    ...
    public void ingressACLTcpSyn(Long dpidLong, String segmentationId, String attachedMac, boolean write,
        ...
        if (write) {
            ...
            InstructionUtils.createGotoTableInstructions(ib, LBAAS_ACL);
            ib.setOrder(0);
