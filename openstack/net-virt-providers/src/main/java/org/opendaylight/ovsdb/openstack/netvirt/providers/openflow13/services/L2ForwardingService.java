...
public class L2ForwardingService extends AbstractServiceInstance implements ConfigInterface, L2ForwardingProvider {
    ...
    public void programLocalUcastOut(Long dpidLong, String segmentationId,
        ...
        initFlowBuilder(flowBuilder, flowName);
        ...
        if (write) {
            ...
            setFlowBuilderInstruction(flowBuilder, setOutputPortInstruction);
    ...
    private FlowBuilder initFlowBuilder(FlowBuilder flowBuilder, String flowName) {
    ...
    public void programLocalBcastOut(Long dpidLong, String segmentationId, Long localPort, boolean write) {
        ...
        List<Instruction> existingInstructions = extractExistingInstructions(flow);
        ...
        if (write) {
            ...
            // Add InstructionsBuilder to FlowBuilder
            setFlowBuilderInstruction(flowBuilder, outputPortInstruction);
    ...
    private void setFlowBuilderInstruction(FlowBuilder flowBuilder, Instruction instruction) {
    ...
    private List<Instruction> extractExistingInstructions(Flow flow) {
    ...
    public void programLocalVlanBcastOut(Long dpidLong, String segmentationId,
        ...
        if (write) {
            ...
            // Add InstructionsBuilder to FlowBuilder
            setFlowBuilderInstruction(flowBuilder, applyActionsInstruction);
            writeFlow(flowBuilder, nodeBuilder);
        } else {
            InstructionBuilder ib = new InstructionBuilder();
    ...
    public void programLocalTableMiss(Long dpidLong, String segmentationId, boolean write) {
        ...
        if (write) {
            ...
            // Add InstructionsBuilder to FlowBuilder
            setFlowBuilderInstruction(flowBuilder, dropInstruction);
        }
    ...
    public void programTunnelFloodOut(Long dpidLong, String segmentationId, Long OFPortOut, boolean write) {
        ...
        if (write) {
            ...
            if (flowRemove) {
                ...
                // Add InstructionsBuilder to FlowBuilder
                setFlowBuilderInstruction(flowBuilder, instruction);
                writeFlow(flowBuilder, nodeBuilder);
            }
        }
    }
    ...
    public void programTunnelMiss(Long dpidLong, String segmentationId, boolean write) {
        ...
        if (write) {
            ...
            // Add InstructionsBuilder to FlowBuilder
            setFlowBuilderInstruction(flowBuilder, mutablePipelineInstruction);
        }
