...
public class ArpResponderServiceTest {
    ...
    public void testProgramStaticArpEntry() throws Exception {
        ...
        // test for Action.ADD
        assertEquals("Error, did not return the expected StatusCode", new Status(StatusCode.SUCCESS), arpResponderService.programStaticArpEntry(mock(Node.class), Long.valueOf(12), SEGMENTATION_ID, MAC_ADDRESS, ipAddress, Action.ADD));
        ...
        assertEquals("Error, did not return the expected StatusCode", new Status(StatusCode.SUCCESS), arpResponderService.programStaticArpEntry(mock(Node.class), Long.valueOf(12), SEGMENTATION_ID, MAC_ADDRESS, ipAddress, Action.DELETE));
