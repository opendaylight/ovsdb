...
public class NetvirtSfcIT extends AbstractMdsalTestBase {
    ...
    public void testNetvirtSfcPipeline() throws InterruptedException {
        ...
        itUtils.verifyFlow(nodeInfo.datapathId, flowId, pipelineOrchestrator.getTable(Service.SFC_CLASSIFIER));
    ...
    public void testNetvirtSfcAll() throws Exception {
        ...
        itUtils.verifyFlow(nodeInfo.datapathId, flowId, pipelineOrchestrator.getTable(Service.CLASSIFIER));
        flowId = FlowNames.getArpResponder(SF1IP);
        itUtils.verifyFlow(nodeInfo.datapathId, flowId, pipelineOrchestrator.getTable(Service.ARP_RESPONDER));
