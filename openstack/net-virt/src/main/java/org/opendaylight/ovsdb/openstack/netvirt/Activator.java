...
public class Activator extends ComponentActivatorAbstractBase {
    ...
    public void configureInstance(Component c, Object imp,
        ...
        if (imp.equals(FloatingIPHandler.class)) {
            ...
            floatingIPHandlerPorperties.put(Constants.EVENT_HANDLER_PROPERTY,
        ...
        if (imp.equals(NetworkHandler.class)) {
            ...
            networkHandlerProperties.put(Constants.EVENT_HANDLER_PROPERTY,
        ...
        if (imp.equals(SubnetHandler.class)) {
            ...
            subnetHandlerProperties.put(Constants.EVENT_HANDLER_PROPERTY, AbstractEvent.HandlerType.NEUTRON_SUBNET);
        ...
        if (imp.equals(PortHandler.class)) {
            ...
            portHandlerProperties.put(Constants.EVENT_HANDLER_PROPERTY, AbstractEvent.HandlerType.NEUTRON_PORT);
        ...
        if (imp.equals(RouterHandler.class)) {
            ...
            routerHandlerProperties.put(Constants.EVENT_HANDLER_PROPERTY, AbstractEvent.HandlerType.NEUTRON_ROUTER);
        ...
        if (imp.equals(SouthboundHandler.class)) {
            ...
            southboundHandlerProperties.put(Constants.EVENT_HANDLER_PROPERTY, AbstractEvent.HandlerType.SOUTHBOUND);
        ...
        if (imp.equals(PortSecurityHandler.class)) {
            ...
            portSecurityHandlerProperties.put(Constants.EVENT_HANDLER_PROPERTY,
