...
public class Activator extends ComponentActivatorAbstractBase {
    ...
    public void configureInstance(Component c, Object imp,
        ...
        if (imp.equals(NeutronL3Adapter.class)) {
            ...
            c.add(createServiceDependency().setService(ArpProvider.class).setRequired(true));
            c.add(createServiceDependency().setService(InboundNatProvider.class).setRequired(true));
            c.add(createServiceDependency().setService(OutboundNatProvider.class).setRequired(true));
            c.add(createServiceDependency().setService(RoutingProvider.class).setRequired(true));
            c.add(createServiceDependency().setService(L3ForwardingProvider.class).setRequired(true));
        }
