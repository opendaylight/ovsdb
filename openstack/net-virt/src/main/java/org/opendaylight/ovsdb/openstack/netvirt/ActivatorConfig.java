...
public class ActivatorConfig implements BundleActivator {
    private static final Logger LOG = LoggerFactory.getLogger(ActivatorConfig.class);
    ...
    public ActivatorConfig(ProviderContext providerContext) {
        this.providerContext = providerContext;
    }

    @Override
    public void start(BundleContext context) throws Exception {
        LOG.info("ActivatorConfig start:");
