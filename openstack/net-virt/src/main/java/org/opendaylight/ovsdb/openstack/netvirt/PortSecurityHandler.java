...
public class PortSecurityHandler extends AbstractHandler
    ...
    public void processEvent(AbstractEvent abstractEvent) {
        ...
        switch (ev.getAction()) {
            case ADD:
                doNeutronSecurityRuleAdded(ev.getNeutronSecurityRule());
                break;
            case DELETE:
                doNeutronSecurityRuleDeleted(ev.getNeutronSecurityRule());
                break;
            default:
    ...
    private void doNeutronSecurityRuleAdded(NeutronSecurityRule neutronSecurityRule) {
    ...
    private void doNeutronSecurityRuleDeleted(NeutronSecurityRule neutronSecurityRule) {
        List<NeutronPort> portList = getPortWithSecurityGroup(neutronSecurityRule.getSecurityRuleGroupID());
        for (NeutronPort port:portList) {
