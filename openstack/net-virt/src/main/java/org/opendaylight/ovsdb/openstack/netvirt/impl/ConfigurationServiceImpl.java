...
public class ConfigurationServiceImpl implements ConfigurationService {
    ...
    public String getOpenflowVersion(Node node) {
        ...
        String configuredVersion = Config.getProperty(this.getClass(), "ovsdb.of.version", "1.3");
    ...
    public String getDefaultGatewayMacAddress(Node node) {
        final String l3gatewayForNode =
            node != null ? Config.getProperty(this.getClass(), "ovsdb.l3gateway.mac." + node.getNodeIDString()) : null;
        return l3gatewayForNode != null ? l3gatewayForNode : Config.getProperty(this.getClass(), "ovsdb.l3gateway.mac");
    }
