...
public class SecurityServicesImpl implements ConfigInterface, SecurityServicesManager {
    ...
    public boolean getNeutronPortFromDhcpIntf(
        ...
        if (neutronPort.getDeviceOwner().contains("dhcp")) {
            LOG.warn("getNeutronPortFromDhcpIntf: neutronPort is a dhcp port", neutronPort );
            return true;
        }
        return false;
    }
