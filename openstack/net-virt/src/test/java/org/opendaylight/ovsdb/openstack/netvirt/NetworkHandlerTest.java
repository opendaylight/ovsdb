...
public class NetworkHandlerTest {
    ...
    public void testCanUpdateNetwork() {
        assertEquals("Error, did not return the correct HTTP flag", HttpURLConnection.HTTP_OK, networkHandler.canUpdateNetwork(any(NeutronNetwork.class), any(NeutronNetwork.class)));
    }
    ...
    public void testCanDeleteNetwork() {
        assertEquals("Error, did not return the correct HTTP flag", HttpURLConnection.HTTP_OK, networkHandler.canDeleteNetwork(any(NeutronNetwork.class)));
    }
