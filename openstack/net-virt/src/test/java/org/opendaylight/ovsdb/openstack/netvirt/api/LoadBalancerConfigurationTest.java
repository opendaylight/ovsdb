...
public class LoadBalancerConfigurationTest {
    ...
    private static Map<String, LoadBalancerConfiguration.LoadBalancerPoolMember> lbMap = new HashMap<>();
    private static Object[][] valuesArray = {{"mockUUID1", "mockUUID2"},{"10.10.1.343", "10.10.1.391"},
            {"D5:6B:59:E8:F4:84", "D5:4B:60:E8:F5:84"},{"tcp", "tcp"},
            {Integer.valueOf(125304), Integer.valueOf(125304)}};

    @Before
    public void setUp() throws Exception {
        lbConfig = new LoadBalancerConfiguration();
        lbConfig.addMember(valuesArray[0][0].toString(), valuesArray[1][0].toString(), valuesArray[2][0].toString(),
                valuesArray[3][0].toString(), (Integer)valuesArray[4][0]);
        lbConfig.addMember(valuesArray[0][1].toString(), valuesArray[1][1].toString(), valuesArray[2][1].toString(),
                valuesArray[3][1].toString(), (Integer)valuesArray[4][1]);
    ...
    public void testConstructorLbConfig() throws Exception{
        ...
        assertEquals("getProviderNetworkType() returned the wrong value", "vlan", lbConfigLocal.getProviderNetworkType());
    ...
    public void testAddMember() throws Exception {
        lbConfig.addMember("mockUUID3", "10.10.1.31", "D5:4B:60:E8:F6:84", "http", Integer.valueOf(1204));
