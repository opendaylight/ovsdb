...
public class ConfigurationServiceImplTest {
    ...
    public void testGetTunnelEndPoint() throws Exception {
        ...
        assertEquals("Error, did not return address of tunnelEndPoint", "127.0.0.1", configurationServiceImpl.getTunnelEndPoint(mock(Node.class)).getHostAddress());
    }
    ...
    public void testGetDefaultGatewayMacAddress(){
        ...
        assertEquals("Error, did nor return the defaultGatewayMacAddress of the node", "gateway", configurationServiceImpl.getDefaultGatewayMacAddress(node));
    }
}
