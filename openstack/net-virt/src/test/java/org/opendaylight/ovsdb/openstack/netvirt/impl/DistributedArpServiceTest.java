...
public class DistributedArpServiceTest {
    ...
    public void testSetDependencies() throws Exception {
        ...
        PowerMockito.when(ServiceHelper.getGlobalInstance(TenantNetworkManager.class, distributedArpService)).thenReturn(tenantNetworkManager);
        PowerMockito.when(ServiceHelper.getGlobalInstance(ConfigurationService.class, distributedArpService)).thenReturn(configurationService);
        PowerMockito.when(ServiceHelper.getGlobalInstance(ArpProvider.class, distributedArpService)).thenReturn(arpProvider);
        PowerMockito.when(ServiceHelper.getGlobalInstance(NodeCacheManager.class, distributedArpService)).thenReturn(nodeCacheManager);
        PowerMockito.when(ServiceHelper.getGlobalInstance(Southbound.class, distributedArpService)).thenReturn(southbound);
