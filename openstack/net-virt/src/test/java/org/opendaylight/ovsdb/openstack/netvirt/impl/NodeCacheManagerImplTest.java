...
public class NodeCacheManagerImplTest {
    ...
    public void testCacheListenerAddedAndRemoved() {
        ...
        assertEquals("Error, cacheListenerAdded() did not added any listener", 1, handlers.size());
        // remove
        nodeCacheManagerImpl.cacheListenerRemoved(ref);
        assertEquals("Error, cacheListenerAdded() did not removed any listener", 0, handlers.size());
    }
}
