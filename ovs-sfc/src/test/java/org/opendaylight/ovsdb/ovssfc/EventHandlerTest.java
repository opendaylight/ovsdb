...
public class EventHandlerTest {
    ...
    @Ignore
    @Test(timeout=1000)
    public void testSfpOnDataChange() throws Exception {
        ...
        InstanceIdentifier<?> iID = InstanceIdentifier.builder(ServiceFunctionPaths.class).build();
        Map<InstanceIdentifier<?>, DataObject> updated = new HashMap<InstanceIdentifier<?>, DataObject>();
        updated.put(iID, dataObject);
