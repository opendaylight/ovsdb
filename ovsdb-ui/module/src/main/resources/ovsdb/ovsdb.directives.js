 ...
 */
define(['app/ovsdb/ovsdb.module', 'app/ovsdb/lib/d3', 'app/ovsdb/Graph', 'underscore', 'jquery-ui'], function (ovsdb, d3, Graph, _) {
  'use strict';
  ...
  ovsdb.register.directive('ovsdbGraph', function () {
    return {
      restrict: 'EA',
      scope: false,
      templateUrl: 'src/app/ovsdb/graph_header.tpl.html',
