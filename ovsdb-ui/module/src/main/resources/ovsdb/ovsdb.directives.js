 ...
 */
define(['app/ovsdb/ovsdb.module', 'app/ovsdb/lib/d3.min', 'app/ovsdb/Graph', 'app/ovsdb/LogicalGraph', 'underscore', 'jquery-ui'], function (ovsdb, d3, Graph, LogicalGraph, _) {
  'use strict';
    ...
    return {
      ...
      link: function (scope, ele, attr) {
        ...
        scope.dataPromise.then(function (topo) {
          ...
          graphs.nodes = _.map(topo.nodes, function (value) {
            return {
              node: value
            };
          });
