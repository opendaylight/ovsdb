                                             ...
                                             CommandProvider
{
    ...
    private StatusWithUuid insertSflowRow(Node node, String parent_uuid, SFlow row) {
        ...
        try{
            ...
            // Check SFlow exists in parent (Open_vSwitch) as there can be 0|1
            UUID uuid = new UUID(parent_uuid);
            Bridge bridge = (Bridge)brTable.get(parent_uuid);
    ...
    private StatusWithUuid insertNetFlowRow(Node node, String parent_uuid, NetFlow row) {
        ...
        try{
            ...
            // Check Netflow exists in parent (Open_vSwitch) as there can be 0|1
            // Check SFlow exists in parent (Open_vSwitch) as there can be 0|1
            UUID uuid = new UUID(parent_uuid);
            Bridge bridge = (Bridge)brTable.get(parent_uuid);
