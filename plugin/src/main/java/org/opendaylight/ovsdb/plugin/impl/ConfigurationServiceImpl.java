                                                 ...
                                                 CommandProvider
{
    ...
    private InetAddress getControllerIPAddress(Connection connection) {
        ...
        String addressString = Config.getProperty(this.getClass(), "ovsdb.controller.address");
        ...
        addressString = Config.getProperty(this.getClass(), "of.address");
    ...
    private short getControllerOFPort() {
        ...
        String portString = Config.getProperty(this.getClass(), "of.listenPort");
        if (portString != null) {
            try {
