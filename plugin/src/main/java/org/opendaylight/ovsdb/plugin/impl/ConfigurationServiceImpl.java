...
public class ConfigurationServiceImpl implements OvsdbConfigurationService
{
    ...
    /**     * Function called by the dependency manager when at least one dependency     * become unsatisfied or when the component is shutting down because for     * example bundle is being stopped.     *     */
    void destroy() {
    }
