...
public interface IPFIX extends TypedBaseTable {
    ...
    @TypedColumn(name="cache_max_ﬂows", method=MethodType.GETCOLUMN, fromVersion="7.3.0")
    public Column<GenericTableSchema, Set<Integer>> getCacheMaxFowsColumn();
    @TypedColumn(name="cache_max_ﬂows", method=MethodType.SETDATA, fromVersion="7.3.0")
