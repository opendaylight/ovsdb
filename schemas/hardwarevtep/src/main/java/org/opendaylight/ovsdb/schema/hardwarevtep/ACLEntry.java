...
public interface ACLEntry extends TypedBaseTable {
    @TypedColumn(name="sequence", method=MethodType.GETCOLUMN, fromVersion="1.4.0")
    Column<Long> getSequenceColumn();
    ...
    Column<Set<String>> getSourceMacColumn();
    ...
    Column<Set<String>> getDestMacColumn();
    ...
    Column<Set<String>> getEtherTypeColumn();
    ...
    Column<Set<String>> getSourceIpColumn();
    ...
    Column<Set<String>> getSourceMaskColumn();
    ...
    Column<Set<String>> getDestIpColumn();
    ...
    Column<Set<String>> getDestMaskColumn();
    ...
    Column<Set<Long>> getProtocolColumn();
    ...
    Column<Set<Long>> getSourcePortMinColumn();
    ...
    Column<Set<Long>> getSourcePortMaxColumn();
    ...
    Column<Set<Long>> getDestPortMinColumn();
    ...
    Column<Set<Long>> getDestPortMaxColumn();
    ...
    Column<Set<Long>> getTcpFlagsColumn();
    ...
    Column<Set<Long>> getTcpFlagsMaskColumn();
    ...
    Column<Set<Long>> getIcmpCodeColumn();
    ...
    Column<Set<Long>> getIcmpTypeColumn();
    ...
    Column<Set<String>> getDirectionColumn();
    ...
    Column<Set<String>> getActionColumn();
    ...
    Column<Map<String, String>> getAcleFaultStatusColumn();
