...
public interface Tunnel extends TypedBaseTable {
    ...
    Column<Map<String, String>> getBfdConfigLocalColumn();
    ...
    Column<Map<String, String>> getBfdConfigRemoteColumn();
    ...
    Column<Map<String, String>> getBfdParamsColumn();
