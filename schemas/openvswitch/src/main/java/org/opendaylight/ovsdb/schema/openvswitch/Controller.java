...
public interface Controller extends TypedBaseTable {
    ...
    Column<Long> getBurstLimitColumn();
    ...
    Column<Long> getRateLimitColumn();
    ...
    Column<Set<String>> getConnectionModeColumn();
    ...
    Column<Set<Boolean>> getEnableAsyncMessagesColumn();
    ...
    Column<Set<String>> getLocalNetmaskColumn();
    ...
    Column<Set<String>> getLocalGatewayColumn();
    ...
    Column<Set<String>> getRoleColumn();
    ...
    Column<Set<Long>> getInactivityProbeColumn();
    ...
    Column<Boolean> getIsConnectedColumn();
    ...
    Column<Long> getMaxBackoffColumn();
    ...
    Column<Set<String>> getLocalIpColumn();
    ...
    Column<Set<String>> getDiscoverUpdateResolvConfColumn();
    ...
    @TypedColumn (name = "discover_accept_regex", method = MethodType.GETCOLUMN,
                  fromVersion="1.0.0", untilVersion="3.0.0")
    Column<Set<String>> getDiscoverAcceptRegexColumn();
