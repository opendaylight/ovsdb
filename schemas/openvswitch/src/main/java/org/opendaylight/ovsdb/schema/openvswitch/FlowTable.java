...
public interface FlowTable extends TypedBaseTable {
    ...
    Column<Set<Long>> getFlowLimitColumn() ;
    ...
    Column<Set<String>> getOverflowPolicyColumn() ;
    ...
    Column<Set<String>> getGroupsColumn() ;
    ...
    Column<Set<String>> getNameColumn();
    ...
    Column<Set<String>> getPrefixesColumn();
