...
public interface IPFIX extends TypedBaseTable {
    ...
    Column<Set<Long>> getSamplingColumn();
    ...
    Column<Set<Long>> getObsDomainIdColumn();
    ...
    Column<Set<Long>> getObsPointIdColumn();
    ...
    Column<Set<Long>> getCacheActiveTimeoutColumn();
    ...
    Column<Set<Long>> getCacheMaxFlowsColumn();
