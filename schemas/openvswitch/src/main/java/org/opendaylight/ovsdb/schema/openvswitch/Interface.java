...
public interface Interface extends TypedBaseTable {
    ...
    Column<Map<String, String>> getOptionsColumn();
    ...
    Column<Long> getIngressPolicingRateColumn();
    ...
    Column<Long> getIngressPolicingBurstColumn();
    ...
    Column<Set<String>> getMacInUseColumn();
    ...
    Column<Set<String>> getMacColumn();
    ...
    Column<Set<Long>> getIfIndexColumn();
    ...
    Column<Set<Long>> getOpenFlowPortColumn();
    ...
    Column<Set<Long>> getOpenFlowPortRequestColumn();
    ...
    Column<String> getMonitorColumn();
    ...
    Column<Set<Long>> getCfmMpidColumn();
    ...
    Column<Set<Long>> getCfmRemoteMpidColumn();
    ...
    Column<Set<Long>> getCfmRemoteMpidsColumn();
    ...
    Column<Set<Long>> getCfmFlapCountColumn();
    ...
    Column<Set<Boolean>> getCfmFaultColumn();
    ...
    Column<Set<String>> getCfmFaultStatusColumn();
    ...
    Column<Set<String>> getCfmRemoteOpStateColumn();
    ...
    Column<Set<Long>> getCfmHealthColumn();
    ...
    Column<Set<Boolean>> getLacpCurrentColumn();
    ...
    Column<Map<String, String>> getStatusColumn();
    ...
    Column<Set<String>> getAdminStateColumn();
    ...
    Column<Map<String, String>> getLinkStateColumn();
    ...
    Column<Set<String>> getLinkResetsColumn();
    ...
    Column<Set<Long>> getLinkSpeedColumn();
    ...
    Column<Set<String>> getDuplexColumn();
    ...
    Column<Set<String>> getErrorColumn();
    ...
    Column<Map<String, String>> getLldpColumn();
