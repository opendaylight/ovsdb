...
public interface OpenVSwitch extends TypedBaseTable {
    ...
    Column<Set<UUID>> getBridgesColumn();
    ...
    Column<Set<UUID>> getManagersColumn();
    ...
    Column<Set<UUID>> getManagerOptionsColumn();
    ...
    Column<Long> getNextConfigColumn();
    ...
    Column<Long> getCurrentConfigColumn();
    ...
    Column<Map<String, UUID>> getCapabilitiesColumn();
    ...
    Column<Set<String>> getOvsVersionColumn();
    ...
    Column<Set<String>> getDbVersionColumn();
    ...
    Column<Set<String>> getSystemTypeColumn();
    ...
    Column<Set<String>> getSystemVersionColumn();
    ...
    Column<Set<String>> getDatapathTypesColumn();
    ...
    Column<Set<String>> getIfaceTypesColumn();
