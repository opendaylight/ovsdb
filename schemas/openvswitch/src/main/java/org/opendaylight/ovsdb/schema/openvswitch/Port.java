...
public interface Port extends TypedBaseTable {
    ...
    Column<Set<UUID>> getInterfacesColumn();
    ...
    Column<Set<Long>> getTrunksColumn();
    ...
    Column<Set<String>> getVlanModeColumn();
    ...
    Column<Set<String>> getBondTypeColumn();
    ...
    Column<Set<String>> getBondModeColumn();
    ...
    Column<Set<String>> getLacpColumn();
    ...
    Column<Set<Long>> getBondUpDelayColumn();
    ...
    Column<Set<Long>> getBondDownDelayColumn();
    ...
    Column<Set<Boolean>> getBondFakeInterfaceColumn();
    ...
    Column<Set<Boolean>> getFakeBridgeColumn();
