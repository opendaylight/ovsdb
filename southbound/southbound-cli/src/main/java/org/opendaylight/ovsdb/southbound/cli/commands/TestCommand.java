 ...
 */
package org.opendaylight.ovsdb.southbound.cli.commands;
...
public class TestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(TestCommand.class);
    protected final Commands service;

    public TestCommand(final Commands service) {
