...
public class OvsdbConnectionManager implements OvsdbConnectionListener, AutoCloseable {
    ...
    public Boolean getHaveDeviceOwnership(ConnectionInfo connectionInfo) {
    ...
    public void setHaveDeviceOwnership(ConnectionInfo connectionInfo, Boolean haveDeviceOwnership) {
        OvsdbConnectionInstance ovsdbConnectionInstance = getConnectionInstance(connectionInfo);
        if (ovsdbConnectionInstance != null) {
            ovsdbConnectionInstance.setHaveDeviceOwnership(haveDeviceOwnership);
        }
    }
}
