    ...
    public void onDataChanged(
       ...
       // TODO handle case of updates to ovsdb nodes as needed
        ...
        for (InstanceIdentifier instanceIdentifier : iID) {
            LOG.info("Received removals to ovsdbNode: iID: {} original dObject: {}", instanceIdentifier, originalDataObject.get(instanceIdentifier));
            if (originalDataObject.get(instanceIdentifier) instanceof OvsdbNodeAugmentation) {
                LOG.info("Received removals to ovsdbNodeAugmentation");
                try {
