...
public class OvsdbSouthboundImpl implements OvsdbService {
    ...
    private List<InterfaceTypeEntry> readInterfaceTypesByNodeConnectionIp(IpAddress ipAddress) {
        ...
        String target = new String(ipAddress.getValue());
        String ipAddr = null;
        ...
        if (topology != null && topology.getNode() != null) {
            for (Node node : topology.getNode()) {
                ...
                if (ovsdbNodeAugmentation != null) {
                    ipAddr = new String(ovsdbNodeAugmentation.getConnectionInfo().getRemoteIp().getValue());
                    if(ipAddr.equals(target)) {
