...
public final class SouthboundMapper {
    ...
    public static InstanceIdentifier<Node> createInstanceIdentifier(final InstanceIdentifierCodec instanceIdentifierCodec,
            final OvsdbConnectionInstance client, final Bridge bridge) {
    ...
    @SuppressWarnings("unchecked")
    public static InstanceIdentifier<Node> createInstanceIdentifier(final InstanceIdentifierCodec instanceIdentifierCodec,
            final OvsdbConnectionInstance client, final Controller controller, final String bridgeName) {
        InstanceIdentifier<Node> iid;
