...
public class SouthboundMapper {
    ...
    public static void addQosEntries(List<QosEntries> qosEntries,
        ...
        if (qos != null) {
            ...
            List<QosOtherConfig> qosOtherConfigs = new ArrayList<>();
            Map<String, String> qosOtherConfigMap = qos.getOtherConfigColumn().getData();
            if (qosOtherConfigMap != null && !qosOtherConfigMap.isEmpty()) {
                String qosOtherConfigValueString;
                for (String qosOtherConfigKeyString : qosOtherConfigMap.keySet()) {
                    qosOtherConfigValueString = qosOtherConfigMap.get(qosOtherConfigKeyString);
                    if (qosOtherConfigKeyString != null && qosOtherConfigValueString != null) {
                        qosOtherConfigs.add(new QosOtherConfigBuilder()
                            .setOtherConfigKey(qosOtherConfigKeyString)
                            .setOtherConfigValue(qosOtherConfigValueString).build());
                    }
                }
            }
            ...
            qosEntries.add(new QosEntriesBuilder()
                    ...
                    .setQosOtherConfig(qosOtherConfigs)
