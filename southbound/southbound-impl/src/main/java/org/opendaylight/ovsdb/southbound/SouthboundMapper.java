...
public final class SouthboundMapper {
    ...
    private static final ImmutableBiMap<Class<? extends DatapathTypeBase>, String> DATAPATH_TYPE_MAP =
        ImmutableBiMap.of(
            DatapathTypeSystem.class, "system",
            DatapathTypeNetdev.class, "netdev");
    private static final ImmutableBiMap<String, Class<? extends InterfaceTypeBase>> OVSDB_INTERFACE_TYPE_MAP =
