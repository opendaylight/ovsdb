...
public class SouthboundProvider implements BindingAwareProvider, AutoCloseable {
    ...
    private OvsdbPortTerminationPointDataChangeListener ovsdbPortTerminationPointListener;
    ...
    public void onSessionInitiated(ProviderContext session) {
        ...
        ovsdbPortTerminationPointListener = new OvsdbPortTerminationPointDataChangeListener(db, cm);
    ...
    public void close() throws Exception {
        ...
        ovsdbPortTerminationPointListener.close();
    }
