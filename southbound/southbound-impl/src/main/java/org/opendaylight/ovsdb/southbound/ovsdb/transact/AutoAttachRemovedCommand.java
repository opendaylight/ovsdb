            ...
            if (ovsdbNodeAugmentation != null && deletedOvsdbNodeAugmentation != null) {
                ...
                if (origAutoattachList != null && !origAutoattachList.isEmpty()) {
                    for (Autoattach origAutoattach : origAutoattachList) {
                        ...
                        if (getAutoAttachUuid(deletedAutoattachList, autoAttachId) != null) {
                            LOG.debug("Received request to delete Autoattach entry {} {}", origAutoattach.getAutoattachId(), currentAutoAttach);
        ...
        try {
            ...
            if (nodeOptional.isPresent()) {
                ...
                for (ManagedNodeEntry managedNode : managedNodes) {
                    ...
                    bridge = (optionalBridge.isPresent()) ? optionalBridge.get() : null;
