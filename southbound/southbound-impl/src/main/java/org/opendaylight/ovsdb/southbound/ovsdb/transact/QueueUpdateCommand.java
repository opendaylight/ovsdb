...
/*
                    Mutate<GenericTableSchema> mutate = op.mutate(queue)
                                .addMutation(queue.getExternalIdsColumn().getSchema(),
                                    Mutator.INSERT,
                                    queue.getExternalIdsColumn().getData());
...
/*
                        transaction.add(op.mutate(queue).addMutation(queue.getOtherConfigColumn().getSchema(),
                            Mutator.INSERT,
                            queue.getOtherConfigColumn().getData()));
*/
                    } catch (NullPointerException e) {
