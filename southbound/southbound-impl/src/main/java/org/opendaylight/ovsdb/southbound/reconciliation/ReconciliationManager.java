...
public class ReconciliationManager implements AutoCloseable{
    ...
    private TaskManager connectionReconciliationManager;
    ...
    public void dequeue(final ReconciliationTask task) {
        getTaskManager(task).cancleTask(task.nodeIid);
    }
    ...
    private TaskManager getTaskManager(ReconciliationTask task) {
        if(task instanceof ConnectionReconciliationTask) {
            if(this.connectionReconciliationManager == null){
                this.connectionReconciliationManager = new ConnectionReconciliationTaskManager();
            }
            return this.connectionReconciliationManager;
        }
        return null;
    }
}
