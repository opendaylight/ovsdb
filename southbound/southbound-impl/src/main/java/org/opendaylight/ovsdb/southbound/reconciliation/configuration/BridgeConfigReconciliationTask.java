...
public class BridgeConfigReconciliationTask extends ReconciliationTask {
    ...
    private List<String> reconciliatonBridges = new ArrayList<>();
    ...
    public BridgeConfigReconciliationTask(ReconciliationManager reconciliationManager,
        ...
        reconciliatonBridges.add("/bridge/br-int");
    }

    public void addToReconciliatonBridges(String bridge) {
        reconciliatonBridges.add(bridge);
    }
    @Override
