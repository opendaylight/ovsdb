...
public class OvsdbBridgeUpdateCommand extends TransactionComponent {
    ...
    public void execute(final ReadWriteTransaction transaction) {
        ...
        Map<UUID, Bridge> oldBridgeRows = TyperUtils.extractRowsOld(Bridge.class, getUpdates(), getDbSchema());
