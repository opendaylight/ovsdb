...
public class OvsdbControllerRemovedCommand extends TransactionComponent {
    public OvsdbControllerRemovedCommand() {
        super(Bridge.class, Controller.class);
    }
    ...
    public void execute(final ReadWriteTransaction transaction) {
        ...
        Map<UUID, Controller> removedControllerRows = TyperUtils.extractRowsRemoved(Controller.class,
    ...
    private void deleteControllers(final ReadWriteTransaction transaction,
