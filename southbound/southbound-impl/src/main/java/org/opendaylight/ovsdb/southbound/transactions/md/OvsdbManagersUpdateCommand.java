...
public class OvsdbManagersUpdateCommand extends AbstractTransactionComponent {
    ...
    public void execute(final OvsdbTransactionContext context) {
        ...
        if (updatedManagerRows != null && !updatedManagerRows.isEmpty()) {
            Map<UUID, OpenVSwitch> updatedOpenVSwitchRows = context.getUpdatedRows(OpenVSwitch.class);
