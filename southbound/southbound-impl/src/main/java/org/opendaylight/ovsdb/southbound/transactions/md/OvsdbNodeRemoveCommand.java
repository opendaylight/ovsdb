...
public class OvsdbNodeRemoveCommand extends AbstractTransactionCommand {
    ...
    public OvsdbNodeRemoveCommand(
            ConnectionInfo key,TableUpdates updates,DatabaseSchema dbSchema,
    ...
    public void execute(ReadWriteTransaction transaction) {
        CheckedFuture<Optional<Node>, ReadFailedException> ovsdbNodeFuture = transaction.read(
                LogicalDatastoreType.OPERATIONAL, getConnectionIid());
        ...
        try {
            ...
            if (ovsdbNodeOptional.isPresent()) {
                ...
                transaction.delete(LogicalDatastoreType.OPERATIONAL,getConnectionIid());
            }
        } catch (Exception e) {
