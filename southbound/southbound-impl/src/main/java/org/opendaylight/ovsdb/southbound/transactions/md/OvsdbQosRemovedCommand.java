...
public class OvsdbQosRemovedCommand extends TransactionComponent {
    ...
    public void execute(final ReadWriteTransaction transaction) {
        Map<UUID, Qos> removedQosRows = TyperUtils.extractRowsRemoved(Qos.class, getUpdates(), getDbSchema());
    ...
    private QosEntriesKey getQosEntriesKey(final Node node, final UUID qosUuid) {
    ...
    private void deleteQos(final ReadWriteTransaction transaction,
