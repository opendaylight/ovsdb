...
public class OvsdbQosUpdateCommand extends AbstractTransactionCommand {
    ...
    public OvsdbQosUpdateCommand(final InstanceIdentifierCodec instanceIdentifierCodec,
            final OvsdbConnectionInstance key, final TableUpdates updates, final DatabaseSchema dbSchema) {
        super(key, updates, dbSchema);
        this.instanceIdentifierCodec = instanceIdentifierCodec;
        updatedQosRows = extractRowsUpdated(Qos.class);
        oldQosRows = extractRowsOld(Qos.class);
    ...
    private static void setNewOtherConfigs(final QosEntriesBuilder qosEntryBuilder,
    ...
    private static void setNewExternalIds(final QosEntriesBuilder qosEntryBuilder,
    ...
    private static void removeOldQueues(final ReadWriteTransaction transaction,
    ...
    private static void setNewQueues(final QosEntriesBuilder qosEntryBuilder,
