...
public class OvsdbQosUpdateCommand extends TransactionComponent {
    ...
    public void execute(final ReadWriteTransaction transaction) {
        ...
        final Map<UUID, Qos> updatedQosRows = TyperUtils.extractRowsUpdated(Qos.class,getUpdates(), getDbSchema());
        final Map<UUID, Qos> oldQosRows = TyperUtils.extractRowsOld(Qos.class, getUpdates(), getDbSchema());
        final Map<UUID, Queue> updatedQueueRows = TyperUtils.extractRowsUpdated(Queue.class, getUpdates(), getDbSchema());
     ...
     */
    private void updateQos(final ReadWriteTransaction transaction,
                                  final Map<UUID, Qos> newUpdatedQosRows) {
