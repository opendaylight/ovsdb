...
public class OvsdbQueueRemovedCommand extends AbstractTransactionCommand {
    ...
    private QueuesKey getQueueKey(Node node, UUID queueUuid) {
        ...
        if (queueList == null || queueList.isEmpty()) {
            LOG.info("Deleting Queue {}, Ovsdb Node {} does not have a Queue list.", queueUuid.toString(), node);
            return null;
        }
        ...
        LOG.info("Deleted Queue {} not found in Ovsdb Node {}", queueUuid.toString(), node);
        return null;
    }
