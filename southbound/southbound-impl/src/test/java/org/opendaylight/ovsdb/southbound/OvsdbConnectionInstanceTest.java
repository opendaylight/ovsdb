...
public class OvsdbConnectionInstanceTest {
    ...
    public void testMonitorAllTables() throws Exception {
        ...
        MonitorRequestBuilder monitorBuilder = mock(MonitorRequestBuilder.class);
        PowerMockito.mockStatic(MonitorRequestBuilder.class);
        when(MonitorRequestBuilder.builder(any(TableSchema.class))).thenReturn(monitorBuilder);
