...
@PrepareForTest({SouthboundMapper.class, OvsdbConnectionManager.class, OvsdbConnectionService.class, InstanceIdentifier.class, SouthboundUtil.class})
...
public class OvsdbConnectionManagerTest {
    ...
    //To-Do: add tests for getConnectionInstance() and connect()
}
