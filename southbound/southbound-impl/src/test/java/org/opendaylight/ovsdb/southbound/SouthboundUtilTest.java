...
public class SouthboundUtilTest {
    ...
    public void testGetManagingNode() throws Exception {
        ...
        when(transaction.read(eq(LogicalDatastoreType.OPERATIONAL), any(InstanceIdentifier.class))).thenReturn(
            FluentFutures.immediateFluentFuture(Optional.of(node)));
    ...
    public void testReadNode() {
        ...
        FluentFuture<Optional<DataObject>> value = FluentFutures.immediateFluentFuture(node);
