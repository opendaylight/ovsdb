...
public class SouthboundUtilTest {
    ...
    public void testGetManagingNode() throws Exception {
        ...
        when(transaction.read(eq(LogicalDatastoreType.OPERATIONAL), any(InstanceIdentifier.class)))
    ...
    public void testReadNode() throws Exception {
        ...
        when(transaction.read(LogicalDatastoreType.OPERATIONAL, connectionIid)).thenReturn(
            FluentFutures.immediateFluentFuture(node));
