...
public class SouthboundUtilTest {
    ...
    public void testGetManagingNode() throws Exception {
        ...
        FluentFuture<Optional<Node>> nf = FluentFutures.immediateNullFluentFuture();
    ...
    @SuppressWarnings("unchecked")
    @Test
    public void testReadNode() throws ExecutionException, InterruptedException {
        ...
        FluentFuture<Optional<DataObject>> value = FluentFutures.immediateNullFluentFuture();
