...
public class OvsdbAutoAttachUpdateCommandTest {
    ...
    private static ReadWriteTransaction transaction;

    @SuppressWarnings("unchecked")
    @Before
    public void setUp() throws Exception {
        ovsdbAutoAttachUpdateCommand = PowerMockito.mock(OvsdbAutoAttachUpdateCommand.class, Mockito.CALLS_REAL_METHODS);
        ...
        InstanceIdentifier<Autoattach> aaIid = InstanceIdentifier
                .create(NetworkTopology.class)
                .child(Topology.class, new TopologyKey(SouthboundConstants.OVSDB_TOPOLOGY_ID))
                .child(Node.class, new NodeKey(new NodeId(CONNECTED_NODE_ID)))
                .augmentation(OvsdbNodeAugmentation.class)
                .child(Autoattach.class, mock(AutoattachKey.class));
    ...
    public void testExecute() {
        ...
        verify(transaction).merge(any(LogicalDatastoreType.class), any(InstanceIdentifier.class), any(Autoattach.class));
