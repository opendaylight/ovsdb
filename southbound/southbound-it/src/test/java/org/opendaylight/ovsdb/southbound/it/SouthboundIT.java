...
public class SouthboundIT extends AbstractMdsalTestBase {
    ...
    public void setup() throws InterruptedException {
        ...
        node = connectOvsdbNode2(connectionInfo);
    ...
    private Node connectOvsdbNode2(final ConnectionInfo connectionInfo) throws InterruptedException {
        final InstanceIdentifier<Node> iid = createInstanceIdentifier(connectionInfo);
    ...
    private static void disconnectOvsdbNode2(final ConnectionInfo connectionInfo) throws InterruptedException {
        final InstanceIdentifier<Node> iid = createInstanceIdentifier(connectionInfo);
    ...
    public void testAddDeleteOvsdbNode() throws InterruptedException {
        ...
        disconnectOvsdbNode2(connectionInfo);
        connectOvsdbNode2(connectionInfo);
    }
