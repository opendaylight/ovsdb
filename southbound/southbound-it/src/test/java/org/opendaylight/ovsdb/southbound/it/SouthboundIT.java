...
public class SouthboundIT extends AbstractMdsalTestBase {
    ...
    @Test
    public void testUpdateExistingBridge() throws InterruptedException {
        ...
        for (String testCaseKey : testCases.keySet()) {
            ...
            NodeBuilder bridgeNodeBuilder = new NodeBuilder();
            bridgeNodeBuilder.setNodeId(getBridgeNode(connectionInfo, testBridgeName).getNodeId());
            ...
            // TODO: remove this Thread.sleep()... added to see if waiting a long time would change the outcome
            Thread.sleep(30000);
