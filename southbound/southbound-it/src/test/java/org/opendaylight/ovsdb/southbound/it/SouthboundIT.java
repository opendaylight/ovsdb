...
public class SouthboundIT extends AbstractMdsalTestBase {
    ...
    public void testAddRemoveOvsdbNode() throws InterruptedException {
        ...
        deleteNodeTx.delete(LogicalDatastoreType.CONFIGURATION, SouthboundMapper.createInstanceIdentifier(connectionInfo));
        ...
        try {
            ...
            LOG.debug("Read Operational/DS for Node fail! {}", SouthboundMapper.createInstanceIdentifier(connectionInfo), e);
