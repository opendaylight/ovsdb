...
public class HwvtepSouthboundUtils {
     ...
     * @return the instance identifier
     */
    public static InstanceIdentifier<HwvtepPhysicalPortAugmentation> createPhysicalPortInstanceIdentifier(NodeId nodeId,
            String phyPortName) {
     ...
     * physical switch entry already exists. The operations fails if the
     ...
     *            the logical switch name
     */
    public void updateVlanBindings(NodeId nodeId, String phySwitchName, String phyPortName, int vlanId,
            String logicalSwitchName) {
        NodeId physicalSwitchNodeId = createManagedNodeId(nodeId, phySwitchName);
        VlanBindings vlanBindings = createVlanBinding(nodeId, vlanId, logicalSwitchName);
        ...
        this.mdsalUtils.put(LogicalDatastoreType.CONFIGURATION, iid, phyPortAug);
    }
