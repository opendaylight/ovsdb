...
public class InstructionUtils {
     ...
     */
    public static InstructionBuilder createSendToControllerInstructions(String nodeId, InstructionBuilder ib) {
        ...
        output.setOutputNodeConnector(NodeMapping.toControllerNodeConnectorId(new NodeId(nodeId)));
