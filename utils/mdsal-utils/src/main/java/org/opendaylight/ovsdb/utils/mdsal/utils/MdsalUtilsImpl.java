...
public class MdsalUtilsImpl implements MdsalUtils, AutoCloseable {
    private static final Logger LOG = LoggerFactory.getLogger(MdsalUtilsImpl.class);
     ...
     */
    public MdsalUtilsImpl(DataBroker dataBroker) {
