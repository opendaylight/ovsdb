...
public class DockerOvs implements AutoCloseable {
    ...
    */
     ...
     * @throws InterruptedException
     */
    private void runProcess(long waitFor,StringBuilder capturedStdout, String... words) throws IOException, InterruptedException {
        int exitValue = tryProcess(waitFor, capturedStdout, words);
        assertEquals("DockerOvs.runProcess exit code is not 0", exitValue, 0);
    }
     ...
     * @throws InterruptedException
     */
    private int tryProcess(long waitFor,StringBuilder capturedStdout, String... words) throws IOException, InterruptedException {
