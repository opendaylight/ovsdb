...
public class NodeInfo {
    ...
    private final DataObjectIdentifier<Node> ovsdbIid;
    private final DataObjectIdentifier<Node> bridgeIid;
    ...
    private void addWaiters() {
        ovsdbWaiter = new NotifyingDataChangeListener(LogicalDatastoreType.OPERATIONAL,
            NotifyingDataChangeListener.BIT_CREATE, ovsdbIid.toLegacy(), waitList);
        ...
        bridgeWaiter = new NotifyingDataChangeListener(LogicalDatastoreType.OPERATIONAL,
            NotifyingDataChangeListener.BIT_CREATE, bridgeIid.toLegacy(), waitList);
